...
const IndustrySection = () => {
    ...
    useEffect(() => {
        ...
        if (industryParam && industryParamMap[industryParam]) {
            ...
            const foundIndex = industryData.findIndex(
    ...
    const handleIndustryChange = (index) => {
        ...
        // Find URL key for this industry
    ...
    return (
        <section id="industries" className="bg-stone-100 py-24 lg:py-32 overflow-hidden">
            <div className="container mx-auto px-6">
                ...
                <div
                    key={activeIndex}
                    className="bg-white p-8 sm:p-12 rounded-3xl border border-stone-200 shadow-xl animate-fade-in"
                >
                        ...
                        <div className="lg:col-span-3">
                            ...
                            >
                                ...
                                {activeIndustry.personas.map((persona, index) => {
                                    const position =
                                        personaPositions[index % personaPositions.length];
                                    ...
                                    return (
                                        ...
                                        >
                                            <div className="relative bg-white rounded-2xl shadow-xl p-5 flex items-start gap-5 w-full max-w-md lg:w-max transition-transform duration-300 hover:scale-105 hover:shadow-2xl">
                                                <img
                                                    src={persona.image}
                                                    alt={persona.name}
                        ...
                        <div className="lg:col-span-2 space-y-6 lg:flex lg:flex-col lg:justify-center">
                            <div className="space-y-4">
                                {activeIndustry.useCases.map((useCase) => (
                                    <div
                                        key={useCase.title}
                                        className="bg-stone-50/80 p-5 rounded-2xl border border-stone-200/90 transition-shadow hover:shadow-md"
                                    >
